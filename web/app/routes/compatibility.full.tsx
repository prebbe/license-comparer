...
import { CompatibilityChecker, DataAccess, MetaInformation, LicenseCompatibilityCheckResult } from "../../../core/dist/index";
...
export const loader = () => {
  ...
  const fullCheck = checker.runFullCompatibilityCheck();
